...
To perform a **Contest**, simply roll a **Simple Test** determined by the GM and then use each die landing 8 or higher to
eliminate the highest die from the roll you contested.
...
**3. Eliminating Dice:** These two successful rolls eliminate the two highest dice in Jax's attack pool. Jax's pool was
